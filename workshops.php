...
<body>
  ...
  <header class="header header--workshops">
    <div class="cover"></div>
    <div class="header__content">
      <h1 class="header__content__h1">Workshops</h1>
  ...
  <section class="casestudy triggerNav">
    <h2 class="casestudy__title">Workshops</h2>
    <p class="casestudy__description">
      Group activities on digital creativity.
    </p>
    <div class="casestudy__illu casestudy__illu--workshops">
    </div>
