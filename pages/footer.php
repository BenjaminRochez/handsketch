<footer>
  <div class="redirection">
    ...
    <!-- CONTACT -->
    <ul class="list__title">
      <h3 class="list__title__h3">Contact</h3>
      <li class="list__title__li">
        <a class="list__title__li__a" href="mailto:info@hovertone.com">info@hovertone.com</a>
      </li>
      <li class="list__title__li">
        <small class="list__title__li__small">4 rue des soeurs noires 7000 Mons Belgium</small>
      </li>
    </ul>
  </div>
  <div class="blackbar">
    <p class="blackbar__p">
      Copyright Hovertone SPRL 2016 - TVA : BE0644610629
    </p>
    <div class="blackbar__box">
        <small class="blackbar__box__p">Made with love by <span>DiploStudio</span></small>
